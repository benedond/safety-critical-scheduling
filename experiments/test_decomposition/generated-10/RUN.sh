...
do
	echo $i
	../../../tools/src/ilp_global_solver/main.py --input $i --output $i-global.out > $i-global.log
	../../../tools/bin/visualizer.exe --input $i-global.out --output $i-global.png

	../../../tools/src/ilp_global_solver_gen/main.py --input $i --output $i-global-gen.out > $i-global-gen.log
	...
	../../../tools/src/decomposed_solver/main.py --input $i --output $i-bap.out > $i-bap.log
