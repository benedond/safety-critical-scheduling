...
# Power file by file
python ../get_results.py -i instances/imx8a/ -o results/imx8a.csv -l ../../data/LR-coefficients.json -p imx8a # compute base characteristics
...
python3 ../add_measured_data.py -r ./results/imx8a.csv -m ./measurements/imx8a/ -c power  # add power
